...
% --- TITEL & AUTOREN ---
\title{Algorithmic Bias in LLM-based Decision Support Systems: A Case Study on Austrian Scholarships}
...
\begin{IEEEkeywords}
LLM Bias, Automated Decision Making, Prompt Engineering, Fairness, Llama-3, Scholarship Allocation
\end{IEEEkeywords}
