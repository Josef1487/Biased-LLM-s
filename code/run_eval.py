...
def main():
    ...
    with open(file_path_crit, "r", encoding="utf-8") as f:
        crit_content = f.read()
    cv_header_path = r"C:\Users\gabsu\PycharmProjects\Biased-LLM-s\Header_sozial.txt"
    with open(cv_header_path, "r", encoding="utf-8") as f:
        cv_header = f.read()
    cv_body_path = r"C:\Users\gabsu\PycharmProjects\Biased-LLM-s\Body_sozial.txt"
